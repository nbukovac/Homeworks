...
public class Demo3 {
	...
	public static void main(final String[] args) {
		final String documentBody = Utility.readFromDisk("webroot/scripts/brojPoziva.smscr");
		...
		final RequestContext rc = new RequestContext(System.out, parameters, persistentParameters, cookies);
