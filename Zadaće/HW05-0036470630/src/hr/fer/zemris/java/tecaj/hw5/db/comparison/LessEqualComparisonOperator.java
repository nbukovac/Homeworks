...
/**
 * Class that implements {@link IComparisonOperator} and performs less than or
 * equal, lexicographic comparison between two <code>Strings</code>
 * 
 * @author Nikola Bukovac
 * @version 1.0
 */
public class LessEqualComparisonOperator implements IComparisonOperator {
