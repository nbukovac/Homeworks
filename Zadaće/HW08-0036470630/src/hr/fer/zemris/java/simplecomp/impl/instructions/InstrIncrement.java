...
/**
 * Instrukcija koja povećava trenutni sadržaj registra za 1 te rezultat sprema u
...
public class InstrIncrement implements Instruction {
	...
	/**
	 * Stvara se novi {@link InstrIncrement} objekt kojemu se predaje lista
	 ...
	 * 
	 * @param arguments
	 *            argumenti za Increment instrukciju
	 * @throws IllegalArgumentException
	 *             ako je broj argumenata različit od 1 ili argument nije
	 *             registar s direktnim adresiranjem
	 */
	public InstrIncrement(final List<InstructionArgument> arguments) {
		HelperClass.checkNumberOfArguments(arguments.size(), NUMBER_OF_ARGUMENTS, "Increment");
